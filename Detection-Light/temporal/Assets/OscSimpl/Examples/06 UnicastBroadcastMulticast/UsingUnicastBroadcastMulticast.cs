...
namespace OscSimpl.Examples
{
	public class UsingUnicastBroadcastMulticast : MonoBehaviour
	{
        ...
        public int Nbr_PortIn;
        public int Nbr_PortOut;
        const string address = "/f7/f1";
        const string address2 = "/f7/f2";
        ...
        void Start()
		{
			...
			_oscOut.Open( 9000, "192.168.1.25" );
			...
			_oscIn.MapFloat( address2, OnReceived );
           // _oscIn.MapFloat(address2, OnReceived);
		...
		void Update()
		{
			_oscOut.Send( address, 0.5f );
           // _oscOut.Send(address2, 0.8f);
        }
